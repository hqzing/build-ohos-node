...
for zipfile in *.zip; do unzip -q "$zipfile"; done
rm -rf *.zip
cd -
...
need_no_error_versions="v24.2.0 v24.3.0 v24.4.0 v24.4.1 v24.5.0 v24.6.0 v24.7.0"
...
export CC_host="gcc"
export CXX_host="g++"
./configure --dest-cpu=arm64 --dest-os=openharmony --cross-compiling --partly-static --prefix=node-${version}-openharmony-arm64
make -j$(nproc)
make install
